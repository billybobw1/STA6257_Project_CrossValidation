...
Cross-Validation](images/K-fold-cross-validation-1.png)
Source:[@Ranjan_2021]
...
## Methods - Performance Metrics {.smaller}
...
Formula 4 demonstrate how AUC uses the positive and negative outcomes to
...
-   The dataset contains 13 clinical, body, and lifestyle features from
    299 heart failure patients in Faisalabad, Pakistan in 2015 [@chicco2020machine].
...
::: {.column width="40%"}
-   The age of patients ranged from 40 to 95 years old
...
::: {.column width="40%"}
- Serum Sodium - levels of sodium in the patients bloods
- Platelets - number of platelets in the patient's blood
...
::: {.column width="40%"}
-   All of our categorical variables are encoded as '0'
    and '1'.
...
-   No data points will be removed or altered for our analysis as
    they appear to be genuine observations and should be considered
    in our model.
:::
:::
...
model 1's AUC is significantly better.
...
-   The marginal difference between models supports the argument made by
    ...
    in MSEs as seen in our analysis; models with less predictor
