...
After conducting the analysis, it can be seen that model 2 (m2) provides us
...
higher value. M2 includes only ejection fraction and serum
...
assumes that the number of folds will be equal to the number of observations.
Once again, the cost function is used to find our AUC values. The same function
(glm()) was used to fit our logistic regression models as the other k-fold techniques.
