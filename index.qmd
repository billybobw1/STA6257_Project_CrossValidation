...
**Repeated Splitting:** The data is split into k folds as before, but
this process is repeated n times, with a different random split each
time.

**Model Evaluation:** Just like in K-Fold, models are trained and
evaluated k times on each repetition with different splits, leading to
n\*k total evaluations.

**Final Estimation:** The scores across all repeats are aggregated to
