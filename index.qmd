...
```
Using the Single Hold-Out Method, model 2 provides us with a lower mean squared error. Model 2 includes only ejection fraction and serum creatinine as predictor variables, meaning this reduced model is a better fit according to this cross-validation technique.
...
```
According to LOOCV, our full model (which includes all predictor variables) is a better fit due to a lower mean squared error.
