...
The difference between K-folds and repeated K-folds being as follows:
...
Notably, this technique is especially useful when the data set is not too large and there is a need to ensure the stability of the evaluation metrics across different splits of the data.
...
This perspective is enriched by Cullen Schaffer (1993), who explores the significance of cross-validation in selecting optimal classification methods, highlighting its necessity in dealing with imbalanced datasets through stratified approaches [@schaffer1993selecting].
