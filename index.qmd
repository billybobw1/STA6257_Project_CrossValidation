...
loocv_model = train(DEATH_EVENT ~.,data=data, method="glm",family="binomial", trControl=train_control_loocv)


train_control_k10=trainControl(method="cv",number=10)
k10full= train(DEATH_EVENT ~.,data = data,method="glm",family="binomial",trControl=train_control_k10)
summary(k10full)
```
