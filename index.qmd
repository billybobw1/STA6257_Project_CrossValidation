...
ejection fraction as predictor variables, analysis conducted using
...
While the difference in MSEs between the two models is marginal, the
...
researchers because a model with two predictor variables and a model
with twelve predictor variables can produce the small difference in MSEs
